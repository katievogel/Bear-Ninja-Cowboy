...
var G__43219 = o;
goog.object.set(G__43219,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43241__delegate = function (args){
...
while (G__43242__i < G__43242__a.length) {G__43242__a[G__43242__i] = arguments[G__43242__i + 0]; ++G__43242__i;}
  args = new cljs.core.IndexedSeq(G__43242__a,0,null);
} 
...
var args = cljs.core.seq(arglist__43243);
...
var G__43220 = o;
goog.object.set(G__43220,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43246__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__43247__i < G__43247__a.length) {G__43247__a[G__43247__i] = arguments[G__43247__i + 0]; ++G__43247__i;}
  args = new cljs.core.IndexedSeq(G__43247__a,0,null);
} 
...
var args = cljs.core.seq(arglist__43248);
...
var G__43221 = props;
var G__43221__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43221,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43221);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43221__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43222 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43222,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43222;
}
})(),id_class);
...
var G__43223 = (cljs.core.count(argv) - first_child);
switch (G__43223) {
case (0):
...
var vec__43224 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43224,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43224,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43224,(2),null);
...
var temp__5739__auto___43260 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43260 == null)){
} else {
var key_43261 = temp__5739__auto___43260;
(jsprops.key = key_43261);
}
...
var temp__5739__auto___43265 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43265 == null)){
} else {
var key_43266 = temp__5739__auto___43265;
(jsprops.key = key_43266);
}
...
var temp__5739__auto___43270 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___43270 == null)){
} else {
var key_43274 = temp__5739__auto___43270;
(jsprops.key = key_43274);
}
...
var temp__5739__auto___43275 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43275 == null)){
} else {
var key_43276 = temp__5739__auto___43275;
(jsprops.key = key_43276);
}
...
var temp__5739__auto___43278 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43278 == null)){
} else {
var key_43279 = temp__5739__auto___43278;
(jsprops.key = key_43279);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43227_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43227_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43228 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43228,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43228,(1),null);
...
break;
default:
var G__43302 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43303 = compiler;
v = G__43302;
compiler = G__43303;
continue;
...
var G__43232 = tag;
var G__43232__$1 = (((G__43232 instanceof cljs.core.Keyword))?G__43232.fqn:null);
switch (G__43232__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template43234 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template43234 = (function (opts,id,fn_to_element,meta43235){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta43235 = meta43235;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template43234.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43236,meta43235__$1){
var self__ = this;
var _43236__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43234(self__.opts,self__.id,self__.fn_to_element,meta43235__$1));
}));

(reagent.impl.template.t_reagent$impl$template43234.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43236){
var self__ = this;
var _43236__$1 = this;
return self__.meta43235;
}));

(reagent.impl.template.t_reagent$impl$template43234.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43234.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43234.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43234.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43234.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta43235","meta43235",1265631121,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43234.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43234.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43234");

(reagent.impl.template.t_reagent$impl$template43234.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template43234");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43234.
 */
reagent.impl.template.__GT_t_reagent$impl$template43234 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template43234(opts__$1,id__$1,fn_to_element__$1,meta43235){
return (new reagent.impl.template.t_reagent$impl$template43234(opts__$1,id__$1,fn_to_element__$1,meta43235));
});

}

return (new reagent.impl.template.t_reagent$impl$template43234(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
