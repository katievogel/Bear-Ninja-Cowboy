...
var _STAR_html_mode_STAR__orig_val__51762 = hiccups.runtime._STAR_html_mode_STAR_;
var _STAR_html_mode_STAR__temp_val__51763 = mode;
(hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR__temp_val__51763);

try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {(hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR__orig_val__51762);
}});
/**
...
hiccups.runtime.xml_attribute = (function hiccups$runtime$xml_attribute(var_args){
var G__51768 = arguments.length;
switch (G__51768) {
case 2:
return hiccups.runtime.xml_attribute.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));

break;
case 3:
return hiccups.runtime.xml_attribute.cljs$core$IFn$_invoke$arity$3((arguments[(0)]),(arguments[(1)]),(arguments[(2)]));
...
(hiccups.runtime.xml_attribute.cljs$core$IFn$_invoke$arity$2 = (function (name,value){
return hiccups.runtime.xml_attribute.cljs$core$IFn$_invoke$arity$3(name,value,true);
}));

(hiccups.runtime.xml_attribute.cljs$core$IFn$_invoke$arity$3 = (function (name,value,escape_QMARK_){
return [" ",hiccups.runtime.as_str(name),"=\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(escape_QMARK_)?hiccups.runtime.escape_html(value):value)),"\""].join('');
}));

(hiccups.runtime.xml_attribute.cljs$lang$maxFixedArity = 3);

hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__51776){
var vec__51778 = p__51776;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51778,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51778,(1),null);
if(value === true){
if(hiccups.runtime.xml_mode_QMARK_()){
return hiccups.runtime.xml_attribute.cljs$core$IFn$_invoke$arity$2(name,name);
} else {
return [" ",hiccups.runtime.escape_html(name)].join('');
}
} else {
if(cljs.core.not(value)){
return "";
} else {
return hiccups.runtime.xml_attribute.cljs$core$IFn$_invoke$arity$3(name,((cljs.core.map_QMARK_(value))?(hiccups.runtime.render_attr_map.cljs$core$IFn$_invoke$arity$1 ? hiccups.runtime.render_attr_map.cljs$core$IFn$_invoke$arity$1(value) : hiccups.runtime.render_attr_map.call(null,value)):hiccups.runtime.escape_html(value)),false);
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__51788){
...
var tag = first__51791;
var content = seq__51790__$1;
if((!((((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))))){
throw [cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)," is not a valid tag name"].join('');
} else {
}

var vec__51794 = cljs.core.re_matches(hiccups.runtime.re_tag,hiccups.runtime.as_str(tag));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51794,(0),null);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51794,(1),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51794,(2),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51794,(3),null);
...
var vec__51798 = hiccups.runtime.normalize_element(element);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51798,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51798,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51798,(2),null);
if(cljs.core.truth_(new cljs.core.Keyword(null,"dangerouslySetInnerHTML","dangerouslySetInnerHTML",-554971138).cljs$core$IFn$_invoke$arity$1(attrs))){
return new cljs.core.Keyword(null,"__html","__html",674048345).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"dangerouslySetInnerHTML","dangerouslySetInnerHTML",-554971138).cljs$core$IFn$_invoke$arity$1(attrs));
} else {
if(cljs.core.truth_(new cljs.core.Keyword(null,"dangerously-set-inner-HTML","dangerously-set-inner-HTML",-1133779743).cljs$core$IFn$_invoke$arity$1(attrs))){
return new cljs.core.Keyword(null,"__html","__html",674048345).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"dangerously-set-inner-HTML","dangerously-set-inner-HTML",-1133779743).cljs$core$IFn$_invoke$arity$1(attrs));
} else {
...
return hiccups.runtime.escape_html(x);
