...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_50912 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_50912(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_50916 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_50916(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_50918 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_50918(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_50921 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_50921(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_50925 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_50925(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_50926 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_50926(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_50927 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_50927(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_50928 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_50928(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_50932 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_50932(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_50934 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_50934(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k50874,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50874,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__50885){
var vec__50886 = p__50885;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50886,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50886,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50873){
var self__ = this;
var G__50873__$1 = this;
return (new cljs.core.RecordIter((0),G__50873__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this50875,other50876){
var self__ = this;
var this50875__$1 = this;
return (((!((other50876 == null)))) && ((this50875__$1.constructor === other50876.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50875__$1.status,other50876.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50875__$1.body,other50876.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50875__$1.status_text,other50876.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50875__$1.headers,other50876.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50875__$1.was_aborted,other50876.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50875__$1.__extmap,other50876.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__50873){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__50901 = cljs.core.keyword_identical_QMARK_;
var expr__50902 = k__4388__auto__;
if(cljs.core.truth_((pred__50901.cljs$core$IFn$_invoke$arity$2 ? pred__50901.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__50902) : pred__50901.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__50902)))){
return (new ajax.protocols.Response(G__50873,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50901.cljs$core$IFn$_invoke$arity$2 ? pred__50901.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__50902) : pred__50901.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__50902)))){
return (new ajax.protocols.Response(self__.status,G__50873,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50901.cljs$core$IFn$_invoke$arity$2 ? pred__50901.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__50902) : pred__50901.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__50902)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__50873,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50901.cljs$core$IFn$_invoke$arity$2 ? pred__50901.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__50902) : pred__50901.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__50902)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__50873,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50901.cljs$core$IFn$_invoke$arity$2 ? pred__50901.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__50902) : pred__50901.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__50902)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__50873,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__50873),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__50873){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__50873,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__50877){
var extmap__4419__auto__ = (function (){var G__50908 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__50877,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__50877)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__50908);
} else {
return G__50908;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__50877),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__50877),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__50877),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__50877),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__50877),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
