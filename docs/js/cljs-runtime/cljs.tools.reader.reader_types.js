...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41502 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41502(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41507 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41507(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41508 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41508(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41512 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41512(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41516 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41516(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41525 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41525(reader);
}
});
...
var G__41641 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41642 = s.append(c);
c = G__41641;
s = G__41642;
continue;
}
