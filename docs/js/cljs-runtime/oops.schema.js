...
var G__52731 = cljs.core.first(element_str);
switch (G__52731) {
case "?":
arr.push((1));
...
var G__52737 = cljs.core.next(items);
items = G__52737;
continue;
} else {
return null;
...
var G__52738 = cljs.core.next(items);
items = G__52738;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__52732 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52732) : is_valid_QMARK_.call(null,G__52732));
})())){
var G__52744 = cljs.core.next(cljs.core.next(items));
items = G__52744;
continue;
} else {
return true;
...
switch (G__52735) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__52733_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52733_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__52734_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52734_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52735)].join('')));
